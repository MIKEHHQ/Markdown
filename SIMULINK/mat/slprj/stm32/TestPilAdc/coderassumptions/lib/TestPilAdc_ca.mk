...
#                        of executable (1/0)?
MODEL                = TestPilAdc_ca
MODULES              = coder_assumptions_hwimpl.c coder_assumptions_flt.c TestPilAdc_ca.c
MODULES_OBJ          = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj TestPilAdc_ca.obj 
MAKEFILE             = TestPilAdc_ca.mk
...
NUMST                = 2
NCSTATES             = 0
BUILDARGS            =  OPTS="-DCA_CHECK_FLOATING_POINT_ENABLED=1 -DPROFILING_DEFINE_UINT64_TIMER_TYPE -DCA_CHECK_LONG_LONG_ENABLED=0 -DCA_CHECK_DYNAMIC_MEMORY=0 -DCA_CHECK_DAZ_ENABLED=1"
MULTITASKING         = 1
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB                  = TestPilAdc_ca.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = TestPilAdc_ca_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -IE:/STM32CUBEMX/mat  -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c  -IE:/STM32CUBEMX/mat/slprj/stm32/TestPilAdc/coderassumptions  -IE:/STM32CUBEMX/mat/slprj/stm32/TestPilAdc  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -ID:/STM32-MAT/STM32/addSrc/inc  -IE:/STM32CUBEMX/mat/slprj/stm32/_sharedutils 
...
%.o: $(subst ",,E:/STM32CUBEMX/mat/slprj/stm32/TestPilAdc/coderassumptions)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,E:/STM32CUBEMX/mat/slprj/stm32/TestPilAdc/coderassumptions)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
