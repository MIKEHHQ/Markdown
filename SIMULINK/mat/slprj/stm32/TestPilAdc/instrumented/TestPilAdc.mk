...
#                        of executable (1/0)?
MODEL                = TestPilAdc
MODULES              = TestPilAdc.c TestPilAdc_ADC.c main.c
MODULES_OBJ          = TestPilAdc.obj TestPilAdc_ADC.obj main.obj 
...
NUMST                = 2
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 OPTS="-DTID01EQ=0 -DPROFILING_DEFINE_UINT64_TIMER_TYPE"
MULTITASKING         = 1
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB                  = TestPilAdc_rtwlib.lib
MODELREF_LINK_LIBS        = 
...
# Additional includes
ADD_INCLUDES = \
 -IE:/STM32CUBEMX/mat  -IE:/STM32CUBEMX/mat/slprj/stm32/TestPilAdc  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -ID:/STM32-MAT/STM32/addSrc/inc  -IE:/STM32CUBEMX/mat/slprj/stm32/_sharedutils 
...
%.o: $(subst ",,E:/STM32CUBEMX/mat/slprj/stm32/TestPilAdc)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,E:/STM32CUBEMX/mat/slprj/stm32/TestPilAdc)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
