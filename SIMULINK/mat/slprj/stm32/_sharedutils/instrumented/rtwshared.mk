...
#                        of executable (1/0)?
MODEL                = rtwshared
MODULES              = const_params.c look1_iflf_binlxpw.c
MODULES_OBJ          = const_params.obj look1_iflf_binlxpw.obj 
MAKEFILE             = 
...
# Additional includes
ADD_INCLUDES = \
 -IE:/STM32CUBEMX/mat  -IE:/STM32CUBEMX/mat/slprj/stm32/_sharedutils  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -ID:/STM32-MAT/STM32/addSrc/inc 
