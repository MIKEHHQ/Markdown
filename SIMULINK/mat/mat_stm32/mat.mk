...
#                        of executable (1/0)?
MODEL                = mat
MODULES              = main.c mat_USART.c stm32xxxx_it.c
MODULES_OBJ          = main.obj mat_USART.obj stm32xxxx_it.obj 
MAKEFILE             = mat.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = mat_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -IE:/STM32CUBEMX/mat  -IE:/STM32CUBEMX/mat/mat_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -ID:/STM32-MAT/STM32/addSrc/inc 
